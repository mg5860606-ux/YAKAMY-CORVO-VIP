...
describe(`#getLinkPreview()`, () => {
    ...
    it(`should fetch the resolved DNS address after validation`, () => __awaiter(void 0, void 0, void 0, function* () {
        const fetchResponse = new Response(`<html><head>
        ...
        try {
            const response = yield (0, index_1.getLinkPreview)(`http://example.com/`, {
                resolveDNSHost: () => __awaiter(void 0, void 0, void 0, function* () { return "93.184.216.34"; }),
            });
            expect(response.title).toEqual("Resolved host");
    ...
    it(`should block resolved local addresses in normalized IPv6 forms`, () => __awaiter(void 0, void 0, void 0, function* () {
        const fetchSpy = jest
        ...
        try {
            for (const address of blockedAddresses) {
                yield expect((0, index_1.getLinkPreview)(`http://example.com/`, {
                    resolveDNSHost: () => __awaiter(void 0, void 0, void 0, function* () { return address; }),
